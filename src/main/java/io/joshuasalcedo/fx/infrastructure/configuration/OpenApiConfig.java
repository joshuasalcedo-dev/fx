 ...
 * 
 * <p>This class configures the OpenAPI documentation for the application's REST API.
 * It defines metadata such as API title, description, version, and contact information.</p>
 */
@Configuration
