...
public class ClipboardExportController {
    ...
    @Operation(summary = "Export clipboard entries as JSON", description = "Exports clipboard entries in JSON format")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully exported clipboard entries",
    ...
    public CompletableFuture<ResponseEntity<String>> exportAsJson(
            ...
            @RequestParam(defaultValue = "true") boolean includePinned) {

        log.info("Exporting clipboard entries as JSON - includePinned: {}", includePinned);

        return clipboardService.exportEntries(ClipboardService.ExportFormat.JSON, includePinned)
                .thenApply(content -> {
    ...
    @Operation(summary = "Export clipboard entries as CSV", description = "Exports clipboard entries in CSV format")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully exported clipboard entries",
    ...
    public CompletableFuture<ResponseEntity<String>> exportAsCsv(
        ...
        return clipboardService.exportEntries(ClipboardService.ExportFormat.CSV, includePinned)
                .thenApply(content -> {
    ...
    @Operation(summary = "Export clipboard entries as text", description = "Exports clipboard entries in plain text format")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully exported clipboard entries",
    ...
    public CompletableFuture<ResponseEntity<String>> exportAsText(
        ...
        return clipboardService.exportEntries(ClipboardService.ExportFormat.TXT, includePinned)
                .thenApply(content -> {
